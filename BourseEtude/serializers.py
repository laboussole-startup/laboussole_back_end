...
class BourseEtudeCreationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = BourseEtude
        fields = ['nom','date_limite','niveau','finance','ouvert_pour','pays','statut','description','etablissements_hotes','programme_eligible','nombre_bourse','duree','groupe_cible','avantages_bourse','critères_eligibilite','comment_postuler','page_officielle']
